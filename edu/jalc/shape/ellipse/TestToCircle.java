...
class TestToCircle{
   ...
   public void testEllipseToCircle(){
      ...
      assert(Math.round(Circle.toCircle(ellipse).getArea())== Math.round(ellipse.getArea())); 
   }
   public void testRightTriangleToCircle(){
      ...
      assert(Math.round(Circle.toCircle(righttriangle).getArea())== Math.round(righttriangle.getArea())); 
   }
   public void testRectangleToCircle(){
      ...
      assert(Math.round(Circle.toCircle(rectangle).getArea())== Math.round(rectangle.getArea())); 
   }   
   public void testSquareToCircle(){
      System.out.println("Testing ToCircle :: square to circle");
      Square square = new Square(6.0);
      assert(Math.round(Circle.toCircle(square).getArea()) == Math.round(square.getArea())); 
   }
